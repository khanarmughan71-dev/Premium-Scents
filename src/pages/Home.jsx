        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-6 max-w-xl mx-auto md:mx-0 text-base md:text-lg text-white/80">
              ...
              Designed for those who define their presence.
            </p>
          ...
          <div className="hidden md:flex justify-center">
            <img
              src="/hero02.png"
              alt="Perfume Bottle"
              className="w-90 md:w-80 drop-shadow-2xl water-float"
            />
          </div>
        </div>
        </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="mb-16">
            ...
            <p className="mt-4 max-w-xl text-white/70">
              A curated selection of our most iconic scents, crafted to leave a
              lasting impression.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* Card 1 */}
            <div className="group relative h-90 md:h-105 rounded-2xl overflow-hidden bg-neutral-900">
              <img
                src="/perfume01.jpg"
                alt="Noir Essence"
            ...
            <div className="group relative h-90 md:h-105 rounded-2xl overflow-hidden bg-neutral-900">
              ...
              <div className="relative z-10 h-full flex flex-col justify-end p-8 text-center">
                ...
                <p className="mt-2 text-sm text-white/70">
                  Soft amber with a lasting trail.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-white/75 leading-relaxed">
              At NOIRÉ, we believe a fragrance is more than a scent — it is a
              quiet signature. A reflection of presence, confidence, and
              individuality.
            </p>

            <p className="mt-4 text-white/75 leading-relaxed">
              Each creation is thoughtfully composed using rare ingredients and
              refined accords, blended to evolve naturally on the skin. Our
              process values restraint, balance, and timeless character over
              excess.
            </p>
